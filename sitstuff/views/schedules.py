...
DEBUG = False #to debug and stuff
PER_PAGE = 10 #pagination of schedule results
...
def my_form_post():
    ...
    my_combos = get_schedules.schedule(real_course_list)
    my_errors = get_schedules.get_errors()
